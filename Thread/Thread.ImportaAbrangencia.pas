...
uses
  System.Classes, Controller.Bases, System.SysUtils, FireDAC.Comp.DataSet, FireDAC.Comp.Client,
  Controller.PlanilhaRoteirosExpressas, Controller.AbrangenciaExpressas;
...
var
  ...
  iPos, i: Integer;
  sMensagem: String;
  FRoteiros : TAbrangenciaExpressasController;
begin
  ...
  try
    ...
    FRoteiros := TAbrangenciaExpressasController.Create;
