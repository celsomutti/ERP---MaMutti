object view_TiposConta: Tview_TiposConta
  Left = 0
  Top = 0
  Caption = 'Cadastro de Tipos de Contas Banc'#225'rias'
  ClientHeight = 404
  ClientWidth = 761
  Color = clWhite
  ...
  object memTable: TFDMemTable
    ...
    Left = 360
    object memTablecod_tipo_conta: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'cod_tipo_conta'
    end
    object memTabledes_tipo_conta: TStringField
