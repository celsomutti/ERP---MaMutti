object view_TiposCadastroPessoa: Tview_TiposCadastroPessoa
  Left = 0
  Top = 0
  Caption = 'Cadastro de Tipos de Cadastros de Pessoas'
  ClientHeight = 404
  ClientWidth = 761
  Color = clWhite
    ...
    object gridFormas: TcxGrid
      ...
      object gridFormasDBTableView1: TcxGridDBTableView
        ...
        object gridFormasDBTableView1des_tipo_conta: TcxGridDBColumn
          DataBinding.FieldName = 'des_tipo_cadastro'
  ...
  object memTable: TFDMemTable
    ...
    AfterEdit = memTableAfterEdit
    BeforePost = memTableBeforePost
    AfterPost = memTableAfterPost
    AfterCancel = memTableAfterCancel
    BeforeDelete = memTableBeforeDelete
    ...
    Left = 360
    object memTablecod_tipo_cadastro: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'cod_tipo_cadastro'
    end
    object memTabledes_tipo_cadastro: TStringField
